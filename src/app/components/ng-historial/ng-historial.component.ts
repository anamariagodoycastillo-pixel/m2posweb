...
import { faFileCode, faFileLines, faRotateRight, faSearch, faTimes, faTrash } from "@fortawesome/free-solid-svg-icons";

@Component({
  selector: "app-historial",
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, CardComponent, FontAwesomeModule],
  templateUrl: "./ng-historial.component.html",
  styleUrl: "./ng-historial.component.scss"
})
...
BorrarHistorial() {
    this._sifenService.BorrarHistorial(this.documento.id)
      .subscribe({
        next: (resp) => {
          console.log(resp);
          this.documento.anulado = resp.documento.anulado;
