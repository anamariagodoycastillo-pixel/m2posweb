...
import { faCirclePlus, faCircleXmark, faTimes, faTrash, faWallet } from "@fortawesome/free-solid-svg-icons";
...
@Component({
  ...
  styleUrl: "./ng-cobranza-create.component.scss"
})
...
faCirclePlus = faCirclePlus;
  ...
  public diferencia = computed(() => this.importeTotal - this.importeAbonado());
public vuelto = computed(() => this.importeAbonado() - this.importeCobrado());
  ...
  quitar(index: number) {
     const copia = [...this.detalles()];
  copia.splice(index, 1);
  this.detalles.set(copia); // ✅ Esto actualiza el signal correctamente
  }
  close() {
